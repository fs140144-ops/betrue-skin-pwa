...
const UI = {
  ja: {
    ...
    resetting: "リセット中…",
    customerIdLabel: "顧客ID",
    customerIdPlaceholder: "例：tanaka001",
    guideTitle: "📋 撮影ガイド",
    ...
    alertNeedCustomerId: "顧客IDを入力してください。",
  ...
  en: {
    ...
    customerIdPlaceholder: "e.g. tanaka001",
    ...
    alertNeedCustomerId: "Please enter a customer ID.",
  ...
  pl: {
    ...
    customerIdLabel: "ID klienta",
    customerIdPlaceholder: "np. tanaka001",
    ...
    alertNeedCustomerId: "Podaj ID klienta.",
